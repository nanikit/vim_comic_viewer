import type {
  ...
  TCssProperties,
  TMainBreakPoint,
} from "./stitches_types.ts";
import { React } from "./react.ts";

export * from "@stitches/react";

export declare type TCssProp<T extends TConfig> =
  | TCssProperties<T>
  | (string & {});
/**
 ...
 */
export declare type BreakPointsKeys<Config extends TConfig> =
 ...
 */
export declare type CastNumberToString<Val> = Val extends number ? string & {}
  : never;
/**
...
export declare type TCssWithBreakpoints<Config extends TConfig> =
  & TCssProp<Config>
  & {
    [key in BreakPointsKeys<Config>]?: TCssProp<Config>;
  };
/** The type for the styles in a styled call */
export declare type TComponentStylesObject<Config extends TConfig> =
  & TCssWithBreakpoints<
    Config
  >
  & {
